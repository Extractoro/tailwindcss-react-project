...
const Pricing = () => {
  ...
  return (
    <div className="p-4 md:px-14 max-w-s mx-auto py-10" id="pricing">
      ...
      <motion.div
        ...
        className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 mt-20 md:w-11/12 md:gap-12 gap-10 mx-auto"
      >
